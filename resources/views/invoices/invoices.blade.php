            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                            class="fas fa-plus"></i>&nbsp; اضافة فاتوره </a>
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $invoice->note == true ? $invoices->note : 'لا توجد ملاحظات' }}</td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                     ...
                                                     <a class="dropdown-item"  href="" data-toggle="modal"  data-target="#exampleModal{{ $invoice->id}}">حذف الفاتورة</a>
                                        ...
                                        @include('invoices.deleted')

                                    </tr>

                                    <!-- ارشيف الفاتورة -->
                                    <div class="modal fade" id="Transfer_invoice{{ $invoice->id }}" tabindex="-1"
